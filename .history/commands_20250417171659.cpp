...
/*   Updated: 2025/04/17 17:16:59 by roberto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::modeCmd(std::string channelName, std::vector<std::string>& params, int fd)
{
...
void	Server::modeChannel(std::string channelName, std::vector<std::string>& params, int fd)
{
	/*
